...
module.exports = require('js/app.js').config(function ($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state(require('./state/skill/tailoring/tailoring-state.js'))
            .state(require('./state/skill/tailoring/tailoring-recipes-state.js'))
            .state(require('./state/skill/tailoring/tailoring-weaving-state.js'))
